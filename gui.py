...
# Menu bar
    ...
    # Options
       ...
       # color_theme.add_command(label='Mkbhd',command=self.MKBHD)
        ...
        help_option.add_command(label="About CourseFinderBot", command=self.msg)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("CourseFinderBot v1.0",'CourseFinderBot is a chatbot for answering python queries\nIt is based on retrival-based NLP using pythons NLTK tool-kit module\nGUI is based on Tkinter\nIt can answer questions regarding python language for new learners')

    def about(self):
        tkinter.messagebox.showinfo("CourseFinderBot Developers","Aishwarya Jakka")
