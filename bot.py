 # Meet CourseFinderBot: your friend
...
f=open('course_description.txt','r',errors = 'ignore')
m=open('course_description.txt','r',errors = 'ignore')
...
Introduce_Ans = ["My name is CourseFinderBot.","My name is CourseFinderBot you can called me pi.","Im CourseFinderBot :) ","My name is CourseFinderBot. and my nickname is pi and i am happy to solve your queries :) "]
...
Basic_Q = ("Tell me something about the course 2711?")
Basic_Ans = "This is a graduate level Advanced Database course (3 credits), usually taught in Spring semesters."
Basic_Om = ("Is there any other course recommended along with 2711")
Basic_AnsM = ["CYes, Data Mining makes a good match with Advanced Database."]
